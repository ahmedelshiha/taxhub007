    ...
    const approvals = [
      {
        ...
        decisionAt: new Date(new Date().getTime() - 1000 * 60 * 60 * 24 * 2),
        decisionBy: admin.id,
      },
      {
        id: 'appr_2',
      ...
      },
      {
        ...
        decisionAt: new Date(new Date().getTime() - 1000 * 60 * 60 * 24 * 1),
        decisionBy: admin.id,
      },
      {
        id: 'appr_4',
    ...
    const approvalHistories = [
      {
        ...
        notes: 'Document looks good and complies with all standards',
      ...
      },
      {
        ...
        performedBy: admin.id,
        action: 'APPROVED' as const,
        notes: 'All receipts verified and amounts match supporting documentation',
  ...
  try {
    ...
    const taxFilings = [
      ...
      },
      {
        ...
        entityId: 'entity_1',
        country: 'US',
        taxType: 'ESTIMATED_TAX',
        periodStartDate: new Date('2024-07-01'),
    ...
    const products = [
      {
        id: 'prod_1',
        tenantId: defaultTenant.id,
        productCode: 'BOOK-MONTHLY-001',
        productName: 'Bookkeeping Service - Monthly',
      ...
      },
      {
        id: 'prod_2',
        tenantId: defaultTenant.id,
        productCode: 'TAX-PREP-001',
        productName: 'Tax Preparation Service',
        productType: 'SERVICE' as const,
      ...
      },
      {
        id: 'prod_3',
        tenantId: defaultTenant.id,
        productCode: 'PAYROLL-EMP-001',
        productName: 'Payroll Processing - Per Employee',
        productType: 'SERVICE' as const,
      ...
      },
      {
        id: 'prod_4',
        tenantId: defaultTenant.id,
        productCode: 'CONSULT-HOUR-001',
        productName: 'Financial Consultation Hour',
        productType: 'SERVICE' as const,
